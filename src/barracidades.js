  ...
  render(){
    ...
    function filterFunction() {
      ...
      return (
        <div>
        <div class="dropdown">
            <button onClick = {() => {myFunction();                   {if(this.state.seta==setabaixo){this.setState({seta:setacima});}else {if(this.state.seta==setacima){this.setState({seta:setabaixo});}}};}} class="dropbtn">{this.state.cidade}<img src={this.state.seta} style={{float: "right", marginTop: "4px", marginRight:"4px"}}/></button>
